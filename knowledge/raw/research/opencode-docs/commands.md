...
If you define a custom command with the same name, it will override the built-in command.KeybindsFormattersLightPrivacy PolicyAbout UsContact2026 © OpenCode Documentation | Unofficial, for reference only{"props":{"pageProps":{}},"page":"/en/docs/commands","query":{},"buildId":"po70v7Ev6IrFY6Ww-EB40","nextExport":true,"autoExport":true,"isFallback":false,"scriptLoader":[]}
