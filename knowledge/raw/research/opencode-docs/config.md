...
Schema
The config file has a schema that's defined in opencode.ai/config.json (opens in a new tab).
...
Note: Bearer tokens (AWS_BEARER_TOKEN_BEDROCK or /connect) take precedence over profile-based authentication. See authentication precedence for details.
...
IntroductionProvidersLightPrivacy PolicyAbout UsContact2026 © OpenCode Documentation | Unofficial, for reference only{"props":{"pageProps":{}},"page":"/en/docs/config","query":{},"buildId":"po70v7Ev6IrFY6Ww-EB40","nextExport":true,"autoExport":true,"isFallback":false,"scriptLoader":[]}
