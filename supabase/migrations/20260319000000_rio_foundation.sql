-- Migration: Río Foundation - Schema, Indexing & Security
-- Description: Core tables for the Río AI Assistant foundation, including vector search and conversation memory.
...
CREATE TABLE IF NOT EXISTS public.rio_configurations (
    ...
    prompt_persona TEXT DEFAULT 'friendly', -- friendly, professional, concise
    prompt_language TEXT DEFAULT 'es', -- es, en
...
-- Function sync_mastra_metadata_to_columns() must exist (provided in earlier Mastra hardening)
